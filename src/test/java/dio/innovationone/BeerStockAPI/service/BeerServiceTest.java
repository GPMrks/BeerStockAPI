...
public class BeerServiceTest {
    ...
    @Test
    void whenListAllIsCalledThenAListOfBeersIsReturned() {
        //given
        BeerDTO expectedFoundBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        Beer expectedFoundBeer = beerMapper.toModel(expectedFoundBeerDTO);
    ...
    @Test
    void whenListAllIsCalledThenAListAnEmptyListOfBeer() {
        //when
    ...
    @Test
    void whenDeleteIsCalledWithValidIDThenABeedShouldBeDeleted() throws BeerNotFoundException {
        //given
        ...
        //then
        beerService.deteleBeer(expectedDeletedBeerDTO.getId());
